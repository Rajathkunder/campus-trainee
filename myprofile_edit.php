...
<tr><td><h3 class="name"><i style="font-size:24px" class="fas">	&#xf87b;&nbsp;</i>Phone No</h3>  </td><td><p class="name1"><input type="text" class="na" name="phone" value='.$phone.' required></p></td></tr>

<tr><td><h3 class="name"><i style="font-size:24px" class="fas">		&#xf6f1;&nbsp;</i>Address</h3>  </td><td><p class="name1"><input type="text" class="na" name="address" value="'.$address.'" required></p></td></tr>

<tr><td><h3 class="name"><i style="font-size:24px" class="fas">			&#xf549;&nbsp;</i> Institution</h3>  </td><td><p class="name1"><input type="text" class="na" name="institute" value="'.$institute.'" required></p></td></tr>
